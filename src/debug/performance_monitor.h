...
// MODIFICATION [2025-09-20 22:30] - BIN-REVERT-96-64-001: Remove redundant NUM_FREQS definition
// FAULT DETECTED: Duplicate NUM_FREQS definition conflicts with constants.h
// ROOT CAUSE: Performance monitor independently defines NUM_FREQS=96, overriding constants.h
// SOLUTION RATIONALE: Remove local definition, use constants.h for single source of truth
// IMPACT ASSESSMENT: Ensures consistent NUM_FREQS value across all modules
// VALIDATION METHOD: Verify NUM_FREQS comes from constants.h only
// ROLLBACK PROCEDURE: Restore local definition if compilation issues arise

// Include constants.h for NUM_FREQS definition
#include "constants.h"
