...
void check_knobs(uint32_t t_now) {
  ...
  static float PHOTONS_TARGET __attribute__((unused)) = 1.0;
  static float CHROMA_TARGET __attribute__((unused)) = 1.0;
  static float MOOD_TARGET __attribute__((unused)) = 1.0;

  static float PHOTONS_OUTPUT __attribute__((unused)) = 1.0;
  static float CHROMA_OUTPUT __attribute__((unused)) = 1.0;
  static float MOOD_OUTPUT __attribute__((unused)) = 1.0;

  static float PHOTONS_TARGET_LAST __attribute__((unused)) = 1.0;
  static float CHROMA_TARGET_LAST __attribute__((unused)) = 1.0;
  static float MOOD_TARGET_LAST __attribute__((unused)) = 1.0;
