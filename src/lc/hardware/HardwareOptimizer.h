...
public:
  ...
  bool optimizeGPIOSettings() {
    ...
    gpio_config_t io_conf = {
      .pin_bit_mask = (1ULL << HardwareConfig::LED_DATA_PIN),
    ...
    gpio_set_drive_capability((gpio_num_t)HardwareConfig::LED_DATA_PIN, GPIO_DRIVE_CAP_3);
    
    Serial.print(F("[OPT] GPIO pin "));
    Serial.print(HardwareConfig::LED_DATA_PIN);
