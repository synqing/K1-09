...
SensoryBridge::Config::conf CONFIG = {
  ...
  0.05, // MOOD
  0, // LIGHTSHOW_MODE - Primary channel: LC effect index
  true,           // MIRROR_ENABLED
  ...
  2.0,                 // SENSITIVITY - 1.0 = no gain adjustment, >1.0 = amplify, <1.0 = attenuate
  true,                // BOOT_ANIMATION
...
bool ENABLE_SECONDARY_LEDS = true; // Drive secondary strip by default on dual-channel hardware
