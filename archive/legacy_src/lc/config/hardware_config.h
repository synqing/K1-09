...
namespace HardwareConfig {
    // LED Configuration (dual WS2812 data channels)
    constexpr uint8_t LED_DATA_PIN_PRIMARY = 9;   // Primary LED data pin (Strip 1)
    constexpr uint8_t LED_DATA_PIN_SECONDARY = 10;  // Secondary LED data pin (Strip 2)
    constexpr uint8_t LED_DATA_PIN = LED_DATA_PIN_PRIMARY;  // Backwards compatibility alias
    constexpr uint8_t SECONDARY_LED_DATA_PIN = LED_DATA_PIN_SECONDARY;
    constexpr uint16_t NUM_LEDS = 160;
